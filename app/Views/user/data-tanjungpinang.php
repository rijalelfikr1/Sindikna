...
<head>
  ...
  <link href="assets/vendor/buttons/css/buttons.bootstrap5.min.css" rel="stylesheet">
...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link" href="data-provinsi.html">Data Provinsi</a></li>
          <li><a class="nav-link active" href="data-kab_kot.html">Data Kabupaten-Kota</a></li>
        ...
        <div class="row">
          ...
          <div class="panel table-responsive">
            <table id="provinsi" class="table table-bordered table-hover">
              ...
              <tbody>
                <tr>
                  <td><a href="data-kecamatan.html">Kec. Bukit Bestari</a></td>
                  <td>1</td>
                  <td>1</td>
                  <td>1</td>
                </tr>
                <tr>
                  <td><a href="data-kecamatan.html">Kec. Tanjungpinang Barat</a></td>
                  <td>1</td>
                  <td>1</td>
                  <td>1</td>
                </tr>
                <tr>
                  <td><a href="data-kecamatan.html">Kec. Tanjungpinang Kota</a></td>
                  <td>1</td>
                  <td>1</td>
                  <td>1</td>
                </tr>
                <tr>
                  <td><a href="data-kecamatan.html">Kec. Tanjungpinang Timur</a></td>
                  <td>1</td>
                  <td>1</td>
                  <td>1</td>
                </tr>
  ...
  <script src="assets/vendor/buttons/js/dataTables.buttons.min.js"></script>
  <script src="assets/vendor/buttons/js/buttons.bootstrap5.min.js"></script>
  <script src="assets/vendor/buttons/js/buttons.html5.min.js"></script>
  <script src="assets/vendor/buttons/js/buttons.print.min.js"></script>
