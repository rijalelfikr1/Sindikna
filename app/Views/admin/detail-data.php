                ...
                <section class="section">
                    <div class="section-header">
                        ...
                        <div class="section-header-breadcrumb">
                            ...
                            <div class="breadcrumb-item"><a href="<?= base_url('admin/lihatData'); ?>">Lihat Data</a>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="card card-hero">
                                    <div class="card-header">
                                        ...
                                        <div class="card-description"><?= $DetailUser['Jabatan'] ?>i</div>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="<?= $DetailUser['NIK'] ?>" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label>Nama</label>
                                                    <input type="text" class="form-control"
                                                        value="<?= $DetailUser['Nama'] ?>" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label>Alamat</label>
                                                    <input type="text" class="form-control"
                                                        value="<?= $DetailUser['Alamat'] ?>" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label>Tempat Lahir</label>
                                                    <input type="text" class="form-control"
                                                        value="<?= $DetailUser['Tempat_lahir'] ?>" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label>Tempat Lahir</label>
                                                    <input type="date" class="form-control"
                                                        value="<?= $DetailUser['Tanggal_lahir'] ?>" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label>Agama</label>
                                                    <input type="text" class="form-control"
                                                        value="<?= $DetailUser['Agama'] ?>" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label>No. Telp/HP</label>
                                                    <input type="tel" class="form-control"
                                                        value="<?= $DetailUser['Telp'] ?>" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label>Jenis Kelamin</label>
                                                    <input type="text" class="form-control"
                                                        value="<?= $DetailUser['JK'] ?>" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label>Pendidikan Terakhir</label>
                                                    <input type="text" class="form-control"
                                                        value="<?= $DetailUser['Pendidikan_Terakhir'] ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>NRPTK</label>
                                                    <input type="text" class="form-control"
                                                        value="<?= $DetailUser['NRPTK'] ?>" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label>Kab/Kota Sekolah</label>
                                                    <input type="text" class="form-control" value="<?= $Kota['Kota'] ?>"
                                                        readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label>Pilih Sekolah</label>
                                                    <input type="text" class="form-control"
                                                        value="<?= $Sekolah['sekolah'] ?>" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label>Jabatan</label>
                                                    <input type="text" class="form-control"
                                                        value="<?= $DetailUser['Jabatan'] ?>" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label>Tanggal Masuk</label>
                                                    <input type="date" class="form-control"
                                                        value="<?= $DetailUser['Tanggal_Masuk'] ?>" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label>No. NPWP</label>
                                                    <input type="text" class="form-control"
                                                        value="<?= $DetailUser['No_NPWP'] ?>" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label>No. BPJS Kesehatan</label>
                                                    <input type="text" class="form-control"
                                                        value="<?= $DetailUser['No_BPJS_Kes'] ?>" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label>No. BPJS Tenaga Kerja</label>
                                                    <input type="text" class="form-control"
                                                        value="<?= $DetailUser['No_BPJS_TK'] ?>" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label>Tanggal Keluar</label>
                                                    <input type="date" class="form-control"
                                                        value="<?= $DetailUser['Tgl_keluar'] ?>" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
