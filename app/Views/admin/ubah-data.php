                  ...
                  <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-12 col-md-3 col-lg-3">No. Telp/HP</label>
                                <div class="col-sm-12 col-md-7">
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-12 col-md-3 col-lg-3">Pendidikan Terakhir</label>
                                <div class="col-sm-12 col-md-7">
                                  <input type="text" class="form-control" value="S1 Sejarah">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-7">
                                  <input type="text" class="form-control" value="1292831737293">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-12 col-md-3 col-lg-3">Kab/Kota Sekolah</label>
                                <div class="col-sm-12 col-md-7">
                                  <select class="form-control selectric">
                                    ...
                                    <option selected="selected">Kota Tanjungpinang</option>
                                  </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-12 col-md-3 col-lg-3">Pilih Sekolah</label>
                                <div class="col-sm-12 col-md-7">
                                  <select class="form-control selectric">
                                    ...
                                    <option selected="selected">SMAN 5 Tanjungpinang</option>
                            ...
                            <div class="form-group row">
                              <label class="col-form-label col-12 col-md-3 col-lg-3">Jabatan</label>
                              <div class="col-sm-12 col-md-7">
                                <input type="text" class="form-control" value="Guru Biologi">
                              </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-12 col-md-3 col-lg-3">Tanggal Masuk</label>
                                <div class="col-sm-12 col-md-7">
                                  <input type="date" class="form-control" value="2018-07-20">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-12 col-md-3 col-lg-3">No. NPWP</label>
                                <div class="col-sm-12 col-md-7">
                                  <input type="text" class="form-control" value="91827327182">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-12 col-md-3 col-lg-3">No. BPJS Kesehatan</label>
                                <div class="col-sm-12 col-md-7">
                                  <input type="text" class="form-control" value="38281727261">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-12 col-md-3 col-lg-3">No. BPJS Tenaga Kerja</label>
                                <div class="col-sm-12 col-md-7">
                                  <input type="text" class="form-control" value="1029281817273">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-12 col-md-3 col-lg-3">Tanggal Keluar</label>
                                <div class="col-sm-12 col-md-7">
                        ...
                        <div class="col-12 mt-3">
                            <a href="#" class="btn btn-icon icon-left btn-success mr-2"><i class="far fa-save"></i> Simpan Data</a>
                            <a href="#" class="btn btn-icon icon-left btn-danger"><i class="fas fa-times"></i></i> Batal</a>
                        </div>
