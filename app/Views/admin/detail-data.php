...
<head>
  ...
  <title>Detail Data &mdash; Simdikna</title>
              ...
              <div class="col-12">
                <div class="card card-hero">
                    <div class="card-header">
                        ...
                        <h4>Budi Anton</h4>
                        <div class="card-description">Guru Biologi</div>
                    </div>
                  <div class="card-body">
                    <div class="row">
                       <div class="col-md-6">
                        <div class="form-group">
                            <label>NIK</label>
                            <input type="text" class="form-control" value="210192981" readonly>
                        </div>
                        <div class="form-group">
                            <label>Nama</label>
                            <input type="text" class="form-control" value="Budi Anto" readonly>
                        </div>
                        <div class="form-group">
                            <label>Alamat</label>
                            <input type="text" class="form-control" value="Jl. Kenangan No.12" readonly>
                        </div>
                        <div class="form-group">
                            <label>Tempat Lahir</label>
                            <input type="text" class="form-control" value="Rumah Sakit" readonly>
                        </div>
                        <div class="form-group">
                            <label>Tempat Lahir</label>
                            <input type="date" class="form-control" value="1980-01-08" readonly>
                        </div>
                        <div class="form-group">
                            <label>Agama</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" class="form-control" value="081234567890" readonly>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="S1 Sejarah" readonly>
                        </div>
                       </div>
                       <div class="col-md-6">
                        <div class="form-group">
                            <label>NRPTK</label>
                            <input type="text" class="form-control" value="1292831737293" readonly>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Jabatan</label>
                            <input type="text" class="form-control" value="Guru Biologi" readonly>
                        </div>
                        <div class="form-group">
                            <label>Tanggal Masuk</label>
                            <input type="date" class="form-control" value="2018-07-20" readonly>
                        </div>
                        <div class="form-group">
                            <label>No. NPWP</label>
                            <input type="text" class="form-control" value="91827327182" readonly>
                        </div>
                        <div class="form-group">
                            <label>No. BPJS Kesehatan</label>
                            <input type="text" class="form-control" value="38281727261" readonly>
                        </div>
                        <div class="form-group">
                            <label>No. BPJS Tenaga Kerja</label>
                            <input type="text" class="form-control" value="1029281817273" readonly>
                        </div>
                        <div class="form-group">
