                            ...
                            <td>
                                <ul class="list-inline m-0">
                                  <li class="list-inline-item">
                                    <a href="ubah-data.html" class="btn btn-warning" type="button" data-toggle="tooltip" data-placement="top" title="Ubah"><i class="fas fa-pencil-alt"></i></a>
                                  </li>
                                  <li class="list-inline-item">
                                    <button class="btn btn-danger" data-toggle="modal" data-target="#exampleModal" type="button" data-toggle="tooltip" data-placement="top" title="Hapus"><i class="fas fa-trash"></i></button>
                                  </li>
                                </ul>
                            </td>
                          </tr>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <script src="../assets/js/page/edit-data-ptk.js"></script>
</body>
</html>
